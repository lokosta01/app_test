...
public class DogsFragment extends BaseFragment implements IListFragment {
    ...
    protected void setupActivityComponent(AppComponent appComponent) {
        ...
        vm = ViewModelProviders.of(this, factory).get(DogsFragmentViewModel.class);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements BaseRecyclerAdapter.Binder<Data> {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ViewUtils.navigate(itemView,
                            DogsFragmentDirections.actionDogsGraphToDogFragmentInfo(item.getTitle(),
                                    item.getUrl()));
                }
            });
        }
