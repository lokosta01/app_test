...
public class DogFragmentInfo extends BaseFragment {
    ...
    public String getTitle(){
        return DogFragmentInfoArgs.fromBundle(getArguments()).getTitle();
    }

    public String getImage(){
        return DogFragmentInfoArgs.fromBundle(getArguments()).getUrl();
    }
